...
def main():
    ...
    parser.add_argument('--d2-strategy',type=Path,default=Path(__file__).resolve().parents[2]/'results/long-term-v1.3/EN/state_schema-002.json')
    ...
    report = {
        ...
        'checkpoint_backend':'d2' if args.d2_connection else 'native',
    ...
    try:
        ...
        if args.d2_connection:
            ...
            if args.resume_run:config.runner_config.stop_step=total_steps-checkpoint_step
        if args.resume_run and not args.d2_connection:
        ...
        class Progress(ms.Callback):
            ...
            def on_train_step_end(self, run_context):
                ...
                if logical_step == checkpoint_step or logical_step == total_steps:
                    ...
                    if args.d2_connection and logical_step==checkpoint_step:
