...
def main():
    ...
    try:
        ...
        for rank in range(4):
            ...
            checkpoint_root=args.source_run or args.output
            directory = checkpoint_root / f'training/checkpoint/rank_{rank}'
            step=report['schedule']['checkpoint_step']
            checkpoint = inspect_checkpoint(directory / f'qwen3_rank_{rank}-{step}_1.safetensors', step)
