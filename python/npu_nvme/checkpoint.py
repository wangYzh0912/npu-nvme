...
class DirectCheckpoint:
    ...
    def __new__(cls, *args, strict=False, **kwargs):
        if strict:
            ...
            return StrictCheckpoint(*args, **kwargs)
    ...
    def __init__(
        ...
        backend=None, framework=None, strict=False,
    ):
    ...
    def _mount_filesystem(self):
        ...
        if self.meta_dict.get('strict_contract') == 'D1':
            raise RuntimeError('legacy access to a D1 store is prohibited; use strict=True')
