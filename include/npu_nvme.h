...
/**
 * @brief Raw NPU-SSD transfer for public payloads.
 *
 * Raw IO is checkpoint-independent.  The caller must pass an absolute
 * byte offset that stays outside the protected checkpoint layout.
 */
