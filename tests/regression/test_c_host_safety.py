...
def binary(tmp_path_factory):
    ...
    link_cmd = ['clang','-fsanitize=address,undefined',str(obj),
                '-Wl,--gc-sections,--no-export-dynamic','-lpthread','-o',str(exe)]
...
@pytest.mark.parametrize('case', ['delta_overflow','batch_bound','batch_bytes',
                                  ...
                                  'close_deadline','metadata_timeout','lost_completion'])
