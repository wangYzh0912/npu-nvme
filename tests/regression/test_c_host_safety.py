...
@pytest.mark.parametrize('case', ['streaming_windows','flush_prior_failure','capabilities','pending_limit','write_rotation','read_rotation','checksum_slices','flush_dependency','flush_failed_dependency','read_valid','read_corrupt','read_late','read_query_quarantine','read_record_quarantine','transfer_digest','transfer_invalid','delta_overflow','batch_bound','batch_bytes',
