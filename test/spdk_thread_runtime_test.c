/* =======================================================================
 * spdk_thread_runtime_test.c — diagnostic for DPDK mempool init
 *
...
main(void)
{
    ...
    env_opts.name = "spdk_thread_runtime_test";
    env_opts.shm_id = -1;
    ...
    /* Verify mempool creation works for the SPDK runtime. */
    struct rte_mempool *mp = rte_mempool_create(
        "spdk_thread_runtime_mp", 256, 64, 0, 0,
