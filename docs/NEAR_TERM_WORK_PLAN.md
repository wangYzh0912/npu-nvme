...
GPT-2 XL 500-step 真实轨迹仍在 NPU7 长跑，采用 1～30、236～265、471～500 采样窗；
当前已落盘 39 个样本并完成至约 step 244。中段稀疏采样期间报告的 age 是“采样观察间隔”
而非每一步真实 age，不能作为正式 max-age 结论；待末段窗口和最终结果完成后单独汇报。
