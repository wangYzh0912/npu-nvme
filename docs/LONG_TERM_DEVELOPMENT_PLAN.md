...
### B2 组合验收完成（2026-09-14）

IO-01/02/03 完成：核心 `a210d16` 的 old/candidate 各36项 H07、`e9e04da` 的双环境各8类读故障与重开、11类 H02、32次重开及隔离生命周期、三 seed 四方法 H01 均通过。最终软件 `9084a54` 274项通过；该提交仅修正验证器识别版本化 SONAME 并增加匹配/错误哈希测试，传输核心和实际加载二进制未改变。汇总逐文件核对核心哈希与各环境二进制哈希，见 `results/long-term-v1.3/B2/acceptance-001.json` 与原始索引。H01 仍是 frozen/legacy caller 对照，不构成 C2 默认 async 验收。IO-04、E0/QW-06、D2/E2 尚未完成。
