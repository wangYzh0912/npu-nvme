...
### B2 acceptance closure

Batches1/2 complete with exact core/binary joins in B2/acceptance-001.json.
Final software274 pass; H01 three seeds/four methods and timed restores pass;
H02 eleven fault cases, lifecycle32 reopens and quarantine cases pass; H07
old/candidate36 cases each plus read fault matrices pass. The final validator
change accepts versioned SONAME paths while requiring exact hashes.
C2a is running at ff034f7; C2b/E0/QW-06/D2/E2 remain unaccepted.

D2 review additionally requires paged physical extent indexes as well as tensor
manifests, semantic/overlap validation after checksums, nonblocking socket I/O
under deadlines, pre-write declared payload validation, and full expected
restore schema before applying any rank. CPU drafts exercise these requirements;
they are not accepted media or rank implementations.
