...
生成时间：2026-09-09 20:11:58 +0800

编排器状态：`unknown`；实验结论按下表逐项判定。本报告只汇总 result.json 中已记录的观测值；缺失项标为“未测”。
...
|---|---:|---:|---:|---|
| P1 | 12 | 12 | 0 | latency_p95=17.83, throughput=4.002e+09, write_ratio=未测, recovery_error=未测 |
| P2 | 0 | 0 | 0 | latency_p95=未测, throughput=未测, write_ratio=未测, recovery_error=未测 |
| P3 | 0 | 0 | 0 | latency_p95=未测, throughput=未测, write_ratio=未测, recovery_error=未测 |
