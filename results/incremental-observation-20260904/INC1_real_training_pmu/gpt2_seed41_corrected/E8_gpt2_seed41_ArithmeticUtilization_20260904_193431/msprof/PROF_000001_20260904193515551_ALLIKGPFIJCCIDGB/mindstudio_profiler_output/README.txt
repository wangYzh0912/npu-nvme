...
1.npu_module_mem.csv:Here is no description about this file: npu_module_mem, please check in 'Profiling Instructions'!
...
7.op_summary.csv:AI Core, AI CPU, AI Vector and Hccl communication operator data,is used to collect statistics on operator details and time consumptions.
...
8.api_statistic.csv:Time spent by AscendCL API, is used to collect statistics on the time spent by API execution at the CANN layer.
